...
import { r as ref, c as computed, a as createElementBlock, o as openBlock, b as createBaseVNode, t as toDisplayString, f as createCommentVNode, F as Fragment, D as renderList, J as normalizeClass, K as createApp, E as onMounted, S as h, w as watch } from "./chunks/runtime-dom.esm-bundler-D4Ustj8G.js";
import { _ as _sfc_main$1 } from "./chunks/CityAutocompleteForm-DVWf4vAL.js";
import { a as apiService } from "./chunks/apiService-Cx0D3LEu.js";
import "./chunks/globalModal-DF8292GH.js";
...
const _hoisted_4 = { class: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 offices-grid" };
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        __props.loading ? (openBlock(), createElementBlock("div", _hoisted_1, _cache[2] || (_cache[2] = [
...
const loadContactsData = async () => {
  ...
  try {
    ...
    const mergedOffices = terminalsData.map((terminal) => {
      let coordinates = [];
