...
import { a0 as toRef, r as ref, w as watch, a as createElementBlock, o as openBlock, af as renderSlot, $ as createCommentVNode, a2 as unref, a7 as normalizeClass, b as createBaseVNode, t as toDisplayString, _ as createTextVNode, d as createVNode, al as withCtx } from "./chunks/runtime-core.esm-bundler-xz8C70T0.js";
import { u as useAuthStore } from "./chunks/auth-BfnmLw6b.js";
import "./chunks/runtime-dom.esm-bundler-DT6Q_ZxL.js";
...
const _hoisted_3 = { class: "flex justify-end gap-3" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        errorMessage.value ? (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(errorMessage.value), 1)) : createCommentVNode("", true),
          ...
          actions: withCtx(({ isSubmitting, isValid, reset }) => [
            createBaseVNode("div", _hoisted_3, [
              ...
              createBaseVNode("button", {
                ...
                isSubmitting ? (openBlock(), createElementBlock("span", _hoisted_5, _cache[0] || (_cache[0] = [
                  createBaseVNode("svg", {
                    class: "w-4 h-4",
                    fill: "none",
                    stroke: "currentColor",
        ...
        btn.addEventListener("click", async (e) => {
          ...
          if (result.type === "success") {
            ...
            if (window.authStore && window.authStore.isLoggedIn) {
              const loginButtons2 = document.querySelectorAll(".open-login-modal-btn");
              loginButtons2.forEach((btn2) => {
                btn2.textContent = window.authStore.userName || "Профиль";
                btn2.classList.remove("open-login-modal-btn");
                btn2.classList.add("user-profile-btn");
                btn2.onclick = () => {
