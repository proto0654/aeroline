import { u as useCssVars, w as withModifiers, v as vModelText } from "./runtime-dom.esm-bundler-DT6Q_ZxL.js";
import { ad as defineComponent, X as toRefs, c as computed, ae as provide, ag as useSlots, r as ref, u as onMounted, w as watch, a as createElementBlock, o as openBlock, b as createBaseVNode, $ as createCommentVNode, a2 as unref, af as renderSlot, F as Fragment, a4 as renderList, ah as normalizeStyle, a7 as normalizeClass, a5 as createBlock, ai as normalizeProps, a3 as mergeProps, t as toDisplayString, aj as guardReactiveProps, _ as createTextVNode, d as createVNode, R as isRef, ak as createSlots, al as withCtx, am as pushScopeId, an as popScopeId, Y as inject, ac as onBeforeUnmount, a1 as withDirectives } from "./runtime-core.esm-bundler-xz8C70T0.js";
...
const _hoisted_1$1 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("span", { class: "arrow arrow-right" }, null, -1));
const _hoisted_2$1 = [
  _hoisted_1$1
];
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        ...
        unref(slots).buttonsPagination ? renderSlot(_ctx.$slots, "buttonsPagination", { key: 0 }, void 0) : createCommentVNode("", true),
        createBaseVNode("div", {
...
const _withScopeId = (n) => (pushScopeId("data-v-32683533"), n = n(), popScopeId(), n);
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("table", { id: unref(tableNodeId) }, [
            ...
            unref(slots)["customize-headers"] ? renderSlot(_ctx.$slots, "customize-headers", { key: 0 }, void 0) : unref(headersForRender).length && !_ctx.hideHeader ? (openBlock(), createElementBlock("thead", {
              key: 1,
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(headersForRender), (header, index) => {
                  return openBlock(), createElementBlock("th", {
                    ...
                    header.text === "checkbox" ? (openBlock(), createBlock(MultipleSelectCheckBox, {
                      ...
                      unref(slots)[`header-${header.value}`] ? renderSlot(_ctx.$slots, `header-${header.value}`, normalizeProps(mergeProps({ key: 0 }, header)), void 0) : unref(slots)[`header-${header.value.toLowerCase()}`] ? renderSlot(_ctx.$slots, `header-${header.value.toLowerCase()}`, normalizeProps(mergeProps({ key: 1 }, header)), void 0) : unref(slots)["header"] ? renderSlot(_ctx.$slots, "header", normalizeProps(mergeProps({ key: 2 }, header)), void 0) : (openBlock(), createElementBlock("span", _hoisted_3$5, toDisplayString(header.text), 1)),
                      ...
                      unref(multiSort) && unref(isMultiSorting)(header.value) ? (openBlock(), createElementBlock("span", _hoisted_4$4, toDisplayString(unref(getMultiSortNumber)(header.value)), 1)) : createCommentVNode("", true)
                    ], 2))
                  ], 14, _hoisted_2$7);
                }), 128))
              ])
            ], 2)) : createCommentVNode("", true),
            unref(ifHasBodySlot) ? renderSlot(_ctx.$slots, "body", normalizeProps(mergeProps({ key: 2 }, unref(pageItems))), void 0) : unref(headerColumns).length ? (openBlock(), createElementBlock("tbody", {
              key: 3,
                ...
                return openBlock(), createElementBlock(Fragment, { key: index }, [
                  createBaseVNode("tr", {
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(headerColumns), (column, i) => {
                      return openBlock(), createElementBlock("td", {
                        ...
                        unref(slots)[`item-${column}`] ? renderSlot(_ctx.$slots, `item-${column}`, normalizeProps(mergeProps({ key: 0 }, item)), void 0) : unref(slots)[`item-${column.toLowerCase()}`] ? renderSlot(_ctx.$slots, `item-${column.toLowerCase()}`, normalizeProps(mergeProps({ key: 1 }, item)), void 0) : column === "expand" ? (openBlock(), createElementBlock("i", {
                          key: 2,
                        ...
                        }, null, 8, ["checked", "onChange"])) : unref(slots)["item"] ? renderSlot(_ctx.$slots, "item", normalizeProps(mergeProps({ key: 4 }, { column, item })), void 0) : (openBlock(), createElementBlock(Fragment, { key: 5 }, [
                  ...
                  unref(ifHasExpandSlot) && unref(expandingItemIndexList).includes(index + unref(prevPageEndIndex)) ? (openBlock(), createElementBlock("tr", {
                    ...
                    createBaseVNode("td", {
                      ...
                      renderSlot(_ctx.$slots, "expand", normalizeProps(guardReactiveProps(item)), void 0)
                    ], 8, _hoisted_7)
                  ], 2)) : createCommentVNode("", true)
                ], 64);
              }), 128)),
          ...
          unref(loading) ? (openBlock(), createElementBlock("div", _hoisted_8, [
            ...
            createBaseVNode("div", _hoisted_10, [
              unref(ifHasLoadingSlot) ? renderSlot(_ctx.$slots, "loading", { key: 0 }, void 0) : (openBlock(), createBlock(Loading, { key: 1 }))
            ])
          ])) : createCommentVNode("", true),
        ...
        !_ctx.hideFooter ? (openBlock(), createElementBlock("div", _hoisted_12, [
          ...
          unref(ifHasPaginationSlot) ? renderSlot(_ctx.$slots, "pagination", normalizeProps(mergeProps({ key: 1 }, {
            ...
            nextPage: unref(nextPage),
            prevPage: unref(prevPage)
          })), void 0) : (openBlock(), createBlock(PaginationArrows, {
            key: 2,
...
var DataTable = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-32683533"]]);
if (typeof window !== "undefined" && window.Vue) {
  window.Vue.createApp({}).component("Vue3EasyDataTable", DataTable);
}
const _hoisted_1 = { class: "easy-data-table-wrapper bg-white rounded-lg" };
const _hoisted_2 = { key: 0 };
const _hoisted_3 = { class: "p-4 border-b border-gray-200" };
const _hoisted_4 = { class: "relative bg-gray-50 rounded-xl" };
const _hoisted_5 = ["placeholder"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "EasyDataTableWrapper",
  props: {
    headers: {},
    items: {},
    ...
    tableClassName: { default: "customize-table" },
    searchable: { type: Boolean, default: false },
    searchField: { default: void 0 },
    searchPlaceholder: { default: "Поиск..." },
    loading: { type: Boolean, default: false },
    emptySlotMessage: { default: "Нет данных" },
    initialSearchValue: { default: "" },
    itemsSelected: { default: () => [] },
    fixedCheckbox: { type: Boolean, default: true },
    selectable: { type: Boolean, default: false },
    searchValue: { default: void 0 }
  },
  emits: ["update:page", "update:rows-per-page", "update:sort", "update:search", "update:itemsSelected", "update:searchValue"],
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const searchValueModel = computed({
      get: () => props.searchValue !== void 0 ? props.searchValue : localSearchValue.value,
      set: (val) => {
    ...
    const itemsSelectedModel = ref(props.itemsSelected);
    ...
    const handleUpdateRowsPerPage = (rows) => {
      emit("update:rows-per-page", rows);
    };
    const handleUpdateSort = (sortBy, sortType) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", _hoisted_4, [
                withDirectives(createBaseVNode("input", {
                  type: "text",
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => searchValueModel.value = $event),
                  placeholder: _ctx.searchPlaceholder,
                  class: "w-full px-5 py-3 bg-transparent rounded-xl focus:outline-none text-gray-800 placeholder-gray-400 pr-12",
                  onInput: onSearchInput
                }, null, 40, _hoisted_5), [
                  [vModelText, searchValueModel.value]
                ]),
                _cache[2] || (_cache[2] = createBaseVNode("span", { class: "absolute right-4 top-1/2 -translate-y-1/2 text-gray-400" }, [
                  createBaseVNode("svg", {
                    class: "w-6 h-6",
                    fill: "none",
                    stroke: "currentColor",
        ...
        createVNode(unref(DataTable), mergeProps({
          ref_key: "easyTableRef",
          ref: easyTableRef,
          headers: _ctx.headers,
          items: _ctx.items,
          "rows-per-page": _ctx.rowsPerPage,
          alternating: _ctx.alternating,
          "border-cell": _ctx.borderCell,
          "buttons-pagination": _ctx.buttonsPagination,
          "show-index": _ctx.showIndex,
          "table-class-name": _ctx.tableClassName,
          "search-field": _ctx.searchField,
          "search-value": searchValueModel.value,
          loading: _ctx.loading,
          "empty-slot-message": _ctx.emptySlotMessage,
          "hide-rows-per-page": "",
          "rows-of-page-separator-message": " из ",
          i18n,
          "theme-color": "#008DD2"
        }, _ctx.selectable ? { "items-selected": itemsSelectedModel.value, "fixed-checkbox": _ctx.fixedCheckbox } : {}, {
          "onUpdate:page": handleUpdatePage,
          "onUpdate:rowsPerPage": handleUpdateRowsPerPage,
          "onUpdate:sort": handleUpdateSort,
          "onUpdate:itemsSelected": _cache[1] || (_cache[1] = ($event) => _ctx.selectable ? itemsSelectedModel.value = $event : null)
        }), createSlots({ _: 2 }, [
          renderList(_ctx.headers, (header) => {
            return {
              name: `header-${header.value}`,
              fn: withCtx((header2) => [
                renderSlot(_ctx.$slots, `header-${header2.value}`, normalizeProps(guardReactiveProps(header2)), () => [
                  createTextVNode(toDisplayString(header2.text), 1)
                ], true)
              ])
            };
          }),
          renderList(_ctx.headers, (header) => {
            return {
              ...
              fn: withCtx((item) => [
                renderSlot(_ctx.$slots, `item-${header.value}`, normalizeProps(guardReactiveProps(item)), void 0, true)
              ])
            };
          })
        ]), 1040, ["headers", "items", "rows-per-page", "alternating", "border-cell", "buttons-pagination", "show-index", "table-class-name", "search-field", "search-value", "loading", "empty-slot-message"])
      ]);
    };
  }
});
const EasyDataTableWrapper = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["__scopeId", "data-v-6b8e69a2"]]);
export {
  EasyDataTableWrapper as E
};
