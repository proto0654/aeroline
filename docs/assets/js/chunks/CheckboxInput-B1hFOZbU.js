import { A as AutocompleteInput } from "./AutocompleteInput-DDLeqRtM.js";
import { r as ref, q as watch, v as onMounted, c as createElementBlock, o as openBlock, d as createCommentVNode, a as createBaseVNode, K as createVNode, F as Fragment, C as renderList, t as toDisplayString, p as computed, D as toRef, y as withDirectives, N as vModelCheckbox, A as unref, G as mergeProps, i as isRef, L as renderSlot, b as createTextVNode } from "./runtime-dom.esm-bundler-BEj-0d2c.js";
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const onFromItemSelected = (item) => {
      from.value = item.city + (item.address ? ", " + item.address : "");
      fromOffice.value = item;
    };
    const onToItemSelected = (item) => {
      to.value = item.city + (item.address ? ", " + item.address : "");
      toOffice.value = item;
    };
...
const CheckboxInput = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bd8eebe4"]]);
export {
  CheckboxInput as C,
  _sfc_main$1 as _
};
