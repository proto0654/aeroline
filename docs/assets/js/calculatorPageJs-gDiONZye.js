...
import { C as CheckboxInput, _ as _sfc_main$b } from "./chunks/CheckboxInput-DRxZfcxQ.js";
...
import { A as AutocompleteInput, a as formatSelectedLocalityName } from "./chunks/AutocompleteInput-LnL3w2YD.js";
import { l as lang, i as index } from "./chunks/ru.es-DrgQ5Xct.js";
import { S as SelectInput } from "./chunks/SelectInput-C2Yd_hDG.js";
import { T as TextareaInput } from "./chunks/TextareaInput-D8e1TVCA.js";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        __props.label ? (openBlock(), createElementBlock("label", {
          ...
          for: inputId.value,
          class: ""
        }, toDisplayString(__props.label), 9, _hoisted_1$a)) : createCommentVNode("", true),
...
const _hoisted_1$9 = { class: "flex items-start relative" };
...
const _hoisted_1$8 = { class: "flex items-center gap-2 mb-4" };
...
const _hoisted_8$3 = { class: "text-sm text-gray-500" };
const _hoisted_9$3 = { class: "flex items-center border border-gray-300 rounded-lg overflow-hidden" };
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (option) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_4$6, [
                ...
                }, toDisplayString(option.label), 9, _hoisted_6$5)
              ]),
              isSelected(option.value) ? (openBlock(), createElementBlock("div", _hoisted_7$5, [
                createBaseVNode("span", _hoisted_8$3, toDisplayString(getUnitLabel(option.value)), 1),
...
const _hoisted_6$4 = { class: "flex items-center border border-gray-300 rounded-lg overflow-hidden" };
const _hoisted_7$4 = ["disabled"];
const _hoisted_8$2 = { class: "px-4 py-2 bg-white text-center min-w-[60px]" };
const _hoisted_9$2 = { class: "border-t border-gray-200 pt-4 flex flex-col gap-4" };
        ...
        createBaseVNode("div", _hoisted_4$5, [
          ...
          __props.showDuplicateButton ? (openBlock(), createElementBlock("div", _hoisted_5$4, [
            ...
            createBaseVNode("div", _hoisted_6$4, [
              ...
              createBaseVNode("span", _hoisted_8$2, toDisplayString(quantity.value), 1),
              createBaseVNode("button", {
                type: "button",
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(packages.value, (pkg, idx) => {
              return openBlock(), createElementBlock("button", {
                ...
                createBaseVNode("span", _hoisted_5$3, [
                  ...
                  pkg.quantity && pkg.quantity > 1 ? (openBlock(), createElementBlock("span", _hoisted_6$3, "(×" + toDisplayString(pkg.quantity) + ")", 1)) : createCommentVNode("", true)
                ]),
...
const _hoisted_1$5 = { class: "card items-stretch" };
...
const DatePickerVue = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-f71b5cbc"]]);
...
const _hoisted_8$1 = { class: "md:col-span-2" };
const _hoisted_9$1 = { class: "md:col-span-2 grid grid-cols-3 gap-4" };
const _hoisted_10$1 = { class: "md:col-span-2" };
const _hoisted_11$1 = { class: "md:col-span-2" };
const _hoisted_12$1 = {
  key: 0,
  class: "md:col-span-2"
};
const _hoisted_13$1 = { class: "md:col-span-2 flex items-center gap-2" };
const _hoisted_14$1 = {
  key: 1,
  class: "md:col-span-2"
};
...
const _hoisted_16$1 = { class: "md:col-span-2 border border-gray-200 rounded-lg p-4 space-y-3" };
const _sfc_main$3 = {
      ...
      return openBlock(), createElementBlock("section", _hoisted_1$3, [
        ...
        createBaseVNode("div", _hoisted_5$2, [
          ...
          deliveryMode.value === "address" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            ...
            !state.value.address.fixedDateTime ? (openBlock(), createElementBlock("div", _hoisted_12$1, [
            ...
            state.value.address.fixedDateTime ? (openBlock(), createElementBlock("div", _hoisted_14$1, [
              createVNode(SelectInput, {
            ...
            __props.namePrefix === "destination" ? (openBlock(), createElementBlock("div", _hoisted_15$1, [
              createVNode(CheckboxInput, {
  ...
  setup(__props) {
      ...
      const result = transportTypes.value.map((transportType) => {
        ...
        if (!direction.fromLocalityId || !direction.toLocalityId) {
          ...
          const tariffZone = tariffZones.value.find(
            (tz) => String(tz.takeLocality_id) === fromLocalityIdStr && String(tz.deliverLocality_id) === toLocalityIdStr && String(tz.transportType_id) === transportTypeIdStr
          );
          if (!tariffZone) {
            ...
            const relevantTariffGrid = tariffGrids.value.filter((tg) => {
              ...
              return tgNumberZone === tariffZoneValue || String(tgNumberZone) === String(tariffZoneValue) || Number(tgNumberZone) === Number(tariffZoneValue);
            });
    ...
    function calculateTariffCost(typeTransportation) {
      ...
      const takeDeliverFrom = takeDelivers.value.find(
        (td) => String(td.billingAddress_id) === String(fromAddress.id) && String(td.transportType_id) === String(typeTransportation.id)
      );
      const takeDeliverTo = takeDelivers.value.find(
        (td) => String(td.billingAddress_id) === String(toAddress.id) && String(td.transportType_id) === String(typeTransportation.id)
      );
      const tariffZoneValue = tariffZone.tariffZone;
